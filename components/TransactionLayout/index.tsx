...
const TransactionModal = (): ReactElement => {
  ...
  const transfer = async () => {
    ...
    try {
      ...
      setTransactionSig("");
      // (c) leverage the SystemProgram class to create transfer instructions that include 
      // your account's public key, the public key from your sender field in the form, and the amount from the form
