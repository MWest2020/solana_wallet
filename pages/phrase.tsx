...
// Import Bip39(up imports) and us it to generate a phrase and convert it to a seed:
const generatedMnemonic = Bip39.generateMnemonic();
// setMnemonic(generatedMnemonic);  //state update

const seed = Bip39.mnemonicToSeedSync(generatedMnemonic).slice(0, 32);

// Import the Keypair class from Solana's web3.js library:
const newAccount = Keypair.fromSeed(seed);
// setAccount(newAccount); //state update
